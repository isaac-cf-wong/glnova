...
We will support the latest stable release of `glnova`.
...
If you discover a security vulnerability in `glnova`,
please report it using **GitHub's private vulnerability reporting feature**:

<!-- prettier-ignore-start -->

1. Go to the [Security](https://github.com/isaac-cf-wong/glnova/security) tab of this repository
...
Thank you for helping make `glnova` better and safer!
