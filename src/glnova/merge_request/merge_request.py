...
class MergeRequest(BaseMergeRequest, Resource):
    """GitLab Merge Request resource class."""
    ...
    def _list_merge_requests(  # noqa: PLR0913
        ...
        **kwargs: Any,
        ...
        Returns:
            A Response object from the API request.
    ...
    def list_merge_requests(  # noqa: PLR0913
        ...
        **kwargs: Any,
        ...
        """
        response = self._list_merge_requests(
            project_id=project_id,
            group_id=group_id,
            approved=approved,
            approved_by_ids=approved_by_ids,
