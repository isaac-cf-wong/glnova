...
def add_command(
    ...
    name: Annotated[
        str,
        typer.Option("--name", help="Name of the account. It does not need to be the same as the GitLab account name."),
    ],
    token: Annotated[str, typer.Option("--token", help="Token for authentication.")],
    base_url: Annotated[str, typer.Option("--base-url", help="Base URL of the platform.")] = "https://gitlab.com",
    ...
    Args:
        ctx: Typer context.
        name: Name of the account. It does not need to be the same as the GitLab account name.
    ...
    from glnova.config.manager import ConfigManager  # noqa: PLC0415
