"""Configuration manager for glnova."""
...
class ConfigManager:
    ...
    def __init__(self, filename: Path | str | None = None) -> None:
        ...
        """
        filename = filename or Path(platformdirs.user_config_dir(appname="glnova")) / "config.yaml"
    ...
    def add_account(
        self, name: str, token: str, base_url: str = "https://gitlab.com", is_default: bool = False
    ) -> None:
        ...
        Args:
            ...
            base_url: Base URL of the GitLab platform.
