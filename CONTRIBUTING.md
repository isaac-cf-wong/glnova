# Contributing to glnova

🎉 Thank you for your interest in contributing to `glnova`!
...
1. Open an Issue
    ...
    [Open an issue](https://github.com/isaac-cf-wong/glnova/issues/new/choose)
...
2. Fork and Clone the Repository
    ...
    ```shell
    git clone git@github.com:<username>/glnova.git
    cd glnova
    ```
...
Thanks again for being part of the `glnova` community!
