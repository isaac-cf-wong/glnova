...
class TestGetVersionInformation:
    ...
    @patch("glnova.utils.log.__version__", "1.0.0")
...
class TestSetupLogger:
    ...
    def test_setup_logger_with_label(self, mock_logger):
        ...
        with patch("glnova.utils.log.Path") as mock_path:
            ...
            with patch("glnova.utils.log.logging.FileHandler"):
    ...
    @patch("glnova.utils.log.get_version_information", return_value="1.0.0")
    def test_setup_logger_print_version(self, mock_get_version, mock_logger):
        ...
        mock_logger.info.assert_called_once_with("Running glnova version: %s", "1.0.0")
