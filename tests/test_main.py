...
class TestMain:
    ...
    @patch("glnova.utils.log.setup_logger")
    def test_main_calls_setup_logger(self, mock_setup_logger):
        ...
        exec(open("src/glnova/__main__.py").read(), {"__name__": "__main__"})  # noqa: SIM115
    ...
    def test_main_not_called_on_import(self, mock_setup_logger):
        ...
        # Import the module (this sets __name__ to 'glnova.__main__')
        import glnova.__main__  # noqa: F401, PLC0415
