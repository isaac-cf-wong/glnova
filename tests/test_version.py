...
class TestVersion:
    ...
    def test_version_installed(self):
        ...
        with patch("importlib.metadata.version", return_value="1.0.0"):
            ...
            importlib.reload(glnova.version)
            from glnova.version import __version__  # noqa: PLC0415
    ...
    def test_version_not_installed(self):
        ...
        with patch("importlib.metadata.version", side_effect=PackageNotFoundError("glnova")):
            importlib.reload(glnova.version)
            from glnova.version import __version__  # noqa: PLC0415
