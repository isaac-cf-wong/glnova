...
from glnova.cli.utils.auth import get_auth_params
...
class TestGetAuthParams:
    ...
    def test_get_auth_params_with_token_and_base_url(self) -> None:
        ...
        assert base_url == "https://custom.gitlab.com"
    ...
    def test_get_auth_params_with_multiple_accounts(self, tmp_path) -> None:
        ...
        config_file.write_text(
            "accounts:\n"
            "  test1:\n    name: test1\n    token: token1\n    base_url: https://gitlab.com\n"
            "  test2:\n    name: test2\n    token: token2\n    base_url: https://enterprise.gitlab.com\n"
        ...
        assert base_url1 == "https://gitlab.com"
        ...
        assert base_url2 == "https://enterprise.gitlab.com"
